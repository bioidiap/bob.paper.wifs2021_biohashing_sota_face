...
#================== Transformers ==================
########
#================== IncResV1 Transformer ==========
# from bob.bio.face.config.baseline.inception_resnetv1_msceleb import transformer
from bob.bio.face.config.baseline.inception_resnetv1_msceleb import load
...
LENGTH = int(128*0.8)  # BioHash length (i.e., number of bits in the resulting BioHash vector)
# **************************************************************************************
