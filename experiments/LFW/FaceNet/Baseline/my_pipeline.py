...
# from bob.bio.face.config.baseline.inception_resnetv1_casiawebface import pipeline
from bob.bio.face.config.baseline.inception_resnetv1_casiawebface import load
