...
########
#================== ArcFace Transformer ===========
# from bob.bio.face.config.baseline.vgg16_oxford import transformer
from bob.bio.face.config.baseline.vgg16_oxford import load
...
LENGTH = int(512*0.125)  # BioHash length (i.e., number of bits in the resulting BioHash vector)
# **************************************************************************************
